...
<hr style="border:1px solid; background-color:#8a7b6d; border-color:#3B3131;">
    ...
    <a href="##customers"   onclick="showCustomers()" ><i class="fa fa-th-list"></i> Etudiants</a>    
    <a href="#products"   onclick="showProductItems()" ><i class="fa fa-th"></i> valider inscription</a>
